const websiteData = {
  header: {
    ...
    ctaButton: {
      text: "Join Community",
      href: "https://chat.whatsapp.com/Dn7SZY5fneI7xEX0hLtm3K"
    }
  },
  hero: {
    ...
    tags: [
      ...
      { text: "Revenue Growth", icon: "📈" },
      { text: "Digital Products", icon: "💎" }
    ]
  },
  about: {
    title: "Who We Are",
  ...
  services: {
    ...
    list: [
      ...
      { title: "Content Strategy & Systems", description: "Design systems that turn your creative ideas into compound assets that attract consistent traffic and leads.", icon: "layout" },
  ...
  faqs: {
    ...
    list: [
      { question: "Can anyone join AlgoGrowthHub?", answer: "Yes! Whether you're just starting out or already scaling up, our free creator community is open to all digital creators committed to execution and building long-term businesses." },
      { question: "How do collaborations work?", answer: "We connect creators based on niche compatibility, target audience alignment, and shared goals. Collaborations include content swaps, newsletters, and joint digital product launches." },
      { question: "Do you provide hands-on services?", answer: "Yes. In addition to our community, we offer dedicated services in short-form, long-form editing, AI automation setups, content pipeline designs, and personal brand auditing. See our services section." },
      { question: "How can I become a featured creator?", answer: "Featured creators are selected based on consistency, execution results, and active community contributions. Active community members are regularly spotlighted on our front page." }
    ]
  },
  booking: {
    ...
    youtube: "https://youtube.com/@algowinner01?si=3Ut3sm1Yj0CYtlo8"
  },
  policies: {
    privacy: {
    ...
    refund: {
      title: "Refund Policy",
      content: `We offer a direct and transparent Refund Policy for all call bookings:<br><br><b>Call Booking Fee</b><br>We charge a nominal commitment fee of ₹50 to filter out spam bookings and secure your slot with our strategists.<br><br><b>Cancellations</b><br>• If you cancel your session at least 24 hours prior to the scheduled time, you are eligible for a 100% refund of your commitment fee.<br>• Cancellations made less than 24 hours in advance will not be refunded, as the slot is locked and cannot be reallocated.<br><br><b>Rescheduling</b><br>You can reschedule your call for free up to 12 hours before the session. Please contact us via email to process any rescheduling or refunds.`
    }
  },
  footer: {
...
// Export data for JS environment
